...
var themeDir = fs.realpathSync(path.join(__dirname, 'theme'));

var themeFiles = fs.readdirSync( themeDir );

var themes = [],
    themeCss = {};

themeFiles.forEach(function(name){
    if (path.extname(name) === '.css') {
        var theme = name.replace(/\.css$/, '');
        themes.push(theme);
        themeCss[theme] = path.join(themeDir, name);
    }
});

exports.themes = themes;
exports.themeCss = themeCss;
exports.defaultTheme = 'parchment';
